...
if [ $sent_stage_training -eq 1 ]; then
    ...
    --beam_size 5 \
    --seed 2022 \
    > train_bartbase_persona_new.log 2>&1 &
fi
...
# evaluating
    ...
    --dev_set_split_name dev \
    --test_set_split_name test \
    --save_result_dir /data1/jxxiang/working/DiffusionDialog_test/find_ori_2024/log/persona/2024-04-02.14-20-46.bartbase \
    --dataset_path $data_root/PersonaChat \
    --log_dir $proj_dir/log \
    --checkpoint_path /data1/jxxiang/working/DiffusionDialog_test/find_ori_2024/log/persona/2024-04-02.14-20-46.bartbase \
    --start_step 1000 \
    --end_step 20000 \
    --interval_steps 1000 \
    --max_source_length 256 \
    ...
    --beam_size 5 \
    --seed 2022 \
    > eval_bartbase_persona_new.log 2>&1 &
fi
