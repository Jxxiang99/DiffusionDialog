...
class BartBaseOutput(ModelOutput):

    loss: Optional[torch.FloatTensor] = None
    masked_loss: Optional[torch.FloatTensor] = None
    logits: torch.FloatTensor = None
    masked_loss: torch.FloatTensor = None
...
class BartEncoder(BartPretrainedModel):
    ...
    def __init__(self, config: BartBaseConfig, embed_tokens: Optional[nn.Embedding] = None):
...
class BartModel(BartPretrainedModel):
    def __init__(self, config: BartBaseConfig):
        super().__init__(config)
...
class BartBaseForConditionalGeneration(BartPretrainedModel):
